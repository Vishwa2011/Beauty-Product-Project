...
//     <Box sx={{ mt: 4, background: '#f0f0f0', padding: '20px', borderRadius: '8px', boxShadow: 2 }}>
//       <Typography variant="h5" gutterBottom sx={{ color: '#8B4513', fontWeight: 'bold' }}>
//         Your Cart
//       </Typography>
//       <Divider sx={{ mb: 2 }} />
//       {cart.length === 0 ? (
...
//       ) : (
//         cart.map((item) => (
//           <Box key={item.id} sx={{ display: 'flex', alignItems: 'center', mb: 2, padding: '10px', border: '1px solid #ccc', borderRadius: '4px', backgroundColor: '#fff' }}>
//             <Typography sx={{ flexGrow: 1, fontWeight: 'medium', color: '#333' }}>{item.name}</Typography>
//             <Typography sx={{ mx: 2, fontWeight: 'medium', color: '#8B4513' }}>${item.price.toFixed(2)}</Typography>
//             <IconButton onClick={() => updateQuantity(item.id, item.quantity - 1)} size="small" disabled={item.quantity <= 1}>
//               <Remove />
//             </IconButton>
...
//               <Add />
//             </IconButton>
//             <Button onClick={() => removeFromCart(item.id)} sx={{ ml: 2, color: '#8B4513', borderColor: '#8B4513', borderWidth: '1px', borderStyle: 'solid', '&:hover': { backgroundColor: '#8B4513', color: '#fff' } }}>
//               Remove
//             </Button>
//           </Box>
//         ))
...
//         <Typography variant="h6" sx={{ mt: 2, color: '#8B4513', fontWeight: 'bold' }}>
